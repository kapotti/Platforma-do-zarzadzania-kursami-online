...
namespace KursyOnline.Controllers
{
    public class LessonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,VideoUrl,CourseId")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,VideoUrl,CourseId")] Lesson lesson)
        {
            if (id != lesson.Id)
            {
                return NotFound();
