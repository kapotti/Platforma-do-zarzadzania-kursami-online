...
namespace KursyOnline.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Link potwierdzający zmianę adresu email został wysłany. Sprawdź swoją pocztę.";
                return RedirectToPage();
            }

            StatusMessage = "Twój adres email nie uległ zmianie.";
            return RedirectToPage();
        }
